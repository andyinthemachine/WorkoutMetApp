...
var ReaderEventStream = (function (_super) {
    ...
    ReaderEventStream.prototype.readLine = function () {
        ...
        for (; this.bufferPos < this.buffer.length; this.bufferPos++) {
            ...
            if (spliceAt !== -1) {
                var line = mongodb_stitch_core_sdk_1.utf8Slice(new Uint8Array(this.buffer.slice(0, this.bufferPos)), 0, this.bufferPos);
    ...
    ReaderEventStream.prototype.dispatchEvent = function () {
        ...
        var event = new mongodb_stitch_core_sdk_1.Event(this.eventName ? this.eventName : mongodb_stitch_core_sdk_1.Event.MESSAGE_EVENT, this.dataBuffer.join(''));
        this.dataBuffer = new Array();
        this.eventName = "";
        if (event.eventName === mongodb_stitch_core_sdk_1.StitchEvent.ERROR_EVENT_NAME) {
...
exports.default = ReaderEventStream;
